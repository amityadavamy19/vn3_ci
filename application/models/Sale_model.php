...
class Sale_model extends CI_Model
{
	...
	public function plan_data() {		
		...
		$SQL = "SELECT *  FROM tbl_subscription_plan  WHERE tbl_subscription_plan.status ='Active'";	
	...
	public function sale_data(){
		...
		$this->load->library('datatable');	
		$id = $this->session->userdata('auserId');
		
		$SQL = "SELECT *  FROM tbl_sales_code  WHERE tbl_sales_code.status ='Active' and agent_id='$id'";	

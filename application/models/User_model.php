...
class User_model extends CI_Model
{
    ...
    {
        $this->db->select('BaseTbl.userId, BaseTbl.email, BaseTbl.name,BaseTbl.plain_pass, BaseTbl.mobile, BaseTbl.createdDtm, Role.role');
        ...
        $this->db->where_in('BaseTbl.roleId ', array(5,6));
        $query = $this->db->get();
    ...
    function getUserRoles()
    {
        ...
        $this->db->where_in('roleId', array(5,6));
        $query = $this->db->get();
    ...
    function count_contact()
	{
        ...
        $query = $this->db->get('tbl_contact_query');

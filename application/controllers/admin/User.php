...
class User extends BaseController
{
    ...
    {
        $this->global['pageTitle'] = 'Dashboard | Vn24';

        $data['ct_request'] = $this->user_model->count_contact();
		 $data['ct_requests'] = $this->user_model->count_partner();
    ...
    function userListing()
    {
        if ($this->isAdmin() == TRUE) {
            ...
            $this->global['pageTitle'] = 'Vn24 | User Listing';
    ...
    function addNew()
    {
        if ($this->isAdmin() == TRUE) {
            ...
            $this->global['pageTitle'] = 'Add New User | Vn24';
        ...
        if ($this->isAdmin() == TRUE) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $userInfo = array(
                    ...
                    'mobile' => $mobile, 'createdBy' => $this->vendorId, 'createdDtm' => date('Y-m-d H:i:s'),'plain_pass'=>$password
                );
    ...
    function editOld($userId = NULL)
    {
        if ($this->isAdmin() == TRUE || $userId == 1) {
            ...
            $this->global['pageTitle'] = 'Vn24 | Edit User';
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if (empty($password)) {
                    ...
                    $userInfo = array(
                        ...
                        'updatedDtm' => date('Y-m-d H:i:s'),'plain_pass'=>$password
                    );
                }
    ...
    function profile($active = "details")
    {
        ...
        $this->global['pageTitle'] = $active == "details" ? 'Admin Profile |  Vn24' : 'Change Password | Vn24';

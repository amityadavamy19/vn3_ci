...
class Home extends CI_Controller
{
	 ...
	 public function pin_search()
    {
          if($_POST['pin'] && $_POST['otype'] == 'Courier')
		  {
			...
			$res = $this->general_model->search_pin('tbl_pincode_serviceable',$_POST['pin']);
			if($res)
			{
	...
	public function pin_search2()
    {
          if($_POST['pin'] && $_POST['otype'] == 'Courier')
		  {
			...
			$res = $this->general_model->search_pin2('tbl_couriers',$_POST['pin']);
			if($res)
			{
		  ...
		  }elseif($_POST['pin'] && $_POST['otype'] == 'Cargo')
		  {
			...
			$res =  $this->general_model->search_pin2('tbl_cargo',$_POST['pin']);
			if($res)
			{
			  foreach($res as $v)
			   {
	 ...
	 public function addOrder()
    {
			...
			{   
				...
				$courier = $this->general_model->getSingleRecord($cour_ser,'name','tbl_couriers');
				 ...
				 if($trans_mode == 'Surface'){
						...
						$amt = $this->db->get_where('tbl_admin_quote',array('pro_type'=>$pro_type,'trans_mode'=>$trans_mode,'zone_name'=>$zone['zone_name'],'courier_id'=> $courier['id']))->row_array()['250g'];
						
						

						}elseif($f_wt <= 500){
						 
						 $amt = $this->db->get_where('tbl_admin_quote',array('pro_type'=>$pro_type,'trans_mode'=>$trans_mode,'zone_name'=>$zone['zone_name'],'courier_id'=>$courier['id']))->row_array()['500g'];

						}elseif($f_wt <= 5000){
						 
						 $amt = $this->db->get_where('tbl_admin_quote',array('pro_type'=>$pro_type,'trans_mode'=>$trans_mode,'zone_name'=>$zone['zone_name'],'courier_id'=>$courier['id']))->row_array()['5000g'];

						}elseif($f_wt <= 20000){
						 
						 $amt = $this->db->get_where('tbl_admin_quote',array('pro_type'=>$pro_type,'trans_mode'=>$trans_mode,'zone_name'=>$zone['zone_name'],'courier_id'=>$courier['id']))->row_array()['20000g'];


						}elseif($f_wt < 50000){

						   $amt = $this->db->get_where('tbl_admin_quote',array('pro_type'=>$pro_type,'trans_mode'=>$trans_mode,'zone_name'=>$zone['zone_name'],'courier_id'=>$courier['id']))->row_array()['2150g'];

						}elseif($f_wt < 100000){
							
							$amt = $this->db->get_where('tbl_admin_quote',array('pro_type'=>$pro_type,'trans_mode'=>$trans_mode,'zone_name'=>$zone['zone_name'],'courier_id'=>$courier['id']))->row_array()['100000g'];
							
						}else{
							
							$amt = $this->db->get_where('tbl_admin_quote',array('pro_type'=>$pro_type,'trans_mode'=>$trans_mode,'zone_name'=>$zone['zone_name'],'courier_id'=>$courier['id']))->row_array()['100000more'];
						}
				 ...
				 }elseif($trans_mode == 'Normal')
				 {
					...
					$amt = $this->db->get_where('tbl_admin_quote',array('pro_type'=>$pro_type,'trans_mode'=>'Air','zone_name'=>$zone['zone_name'],'courier_id'=>$courier['id']))->row_array()['250g'];
					 ...
					 $amt = $this->db->get_where('tbl_admin_quote',array('pro_type'=>$pro_type,'trans_mode'=>'Air','zone_name'=>$zone['zone_name'],'courier_id'=>$courier['id']))->row_array()['500g'];

					}elseif($f_wt <= 5000){
					 
					 $amt = $this->db->get_where('tbl_admin_quote',array('pro_type'=>$pro_type,'trans_mode'=>'Air','zone_name'=>$zone['zone_name'],'courier_id'=>$courier['id']))->row_array()['5000g'];

					}elseif($f_wt <= 50000){
					 
					 $amt = $this->db->get_where('tbl_admin_quote',array('pro_type'=>$pro_type,'trans_mode'=>'Air','zone_name'=>$zone['zone_name'],'courier_id'=>$courier['id']))->row_array()['50000g'];


					}elseif($f_wt < 100000){

					   $amt = $this->db->get_where('tbl_admin_quote',array('pro_type'=>$pro_type,'trans_mode'=>'Air','zone_name'=>$zone['zone_name'],'courier_id'=>$courier['id']))->row_array()['100000g'];
					}
		...
		//echo $this->input->post('c_mode_trans');
		//echo filter_value('d_mode_trans','');
		//echo $f_wt;
		//echo $trans_mode;
		//echo $amt;
		//exit;
	 ...
	 public function addParcel()
    {
    	...
    	public function getOid($id){
            ...
            echo'<!DOCTYPE html>
                    <html>
                    <head>
                    <title>Order Details | Vn24.in </title>
                    </head>
                    <body>
    ...
    {
        $records = $this->general_model->order_data($this->session->userdata('userId'));

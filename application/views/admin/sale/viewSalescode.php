        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>admin/sales/addSaleCode"><i class="fa fa-plus"></i> Add Sales Code</a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Sales Code</h3>
...
<script>
  var table = $('#vendors').dataTable( { 
		...
		ajax: {
            url: "<?=base_url('admin/sales/sale_json')?>",
            type: "GET"
        },
		processing: true,
		serverSide: true, 
		...
		order: [[0, "asc"]],		
		columns: [
        { "targets": 0, "name": "code", 'searchable':true, 'orderable':true},

<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-motorcycle"></i> Pincodes
      <small>View</small>
    </h1>
  </section>
    ...
    <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>admin/pincode/add"><i class="fa fa-plus"></i> Add Pincode</a>
                </div>
            </div>
        </div>
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body table-responsive no-padding">
            <table id="pin_data" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th>Pincode</th>
...
jQuery(document).ready(function(){
	...
	jQuery(document).on("click", ".deleteorder", function(){
		var oid = $(this).data("oid"),
			hitURL = baseURL + "admin/reports/deletepin/",
			currentRow = $(this);
...
<script>
  var table = $('#pin_data').dataTable({
    ...
    ajax: {
      url: "<?= base_url('admin/reports/pin_json/'.$this->uri->segment(4)) ?>",
      type: "GET"
    },
    processing: true,
    serverSide: true,
    ...
    columns: [ 
        { "targets": 0, "name": "pincode", 'searchable':true, 'orderable':true},

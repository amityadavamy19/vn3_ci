...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Order Tracking
        <small>Order Track</small>
      </h1>
    </section>
    ...
    <?php echo form_open_multipart('admin/reports/search_awb', array('id' => 'frm')); ?>
        <div class="col-lg-4">
   ...
   <?php echo form_close(); ?>
	...
	<img src="<?php echo base_url('assets/images/')?>track.png" class="img-responsive">
</div>

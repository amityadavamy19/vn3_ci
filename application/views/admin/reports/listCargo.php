    ...
    <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>admin/cargo/add"><i class="fa fa-plus"></i> Add Cargo</a>
                </div>
            </div>
        </div>
    <div class="row">
...
jQuery(document).ready(function(){
	...
	jQuery(document).on("click", ".deletecargo", function(){
		var oid = $(this).data("oid"),
			hitURL = baseURL + "admin/reports/deletecargo/",
			currentRow = $(this);
...
<script>
  var table = $('#cargo_data').dataTable({
    ...
    ajax: {
      url: "<?= base_url('admin/reports/cargo_json') ?>",
      type: "GET"
    },
    processing: true,
    serverSide: true,

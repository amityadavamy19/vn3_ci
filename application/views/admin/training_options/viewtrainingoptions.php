...
<script>
  var table = $('#training').dataTable( { 
        ...
        { "targets": 3, "name": "c_title", 'searchable':true, 'orderable':true},
        { "targets": 4, "name": "c_description", 'searchable':true, 'orderable':true},
        { "targets": 5, "name": "c_price", 'searchable':false, 'orderable':true},

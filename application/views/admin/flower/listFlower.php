        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url('admin/flower/'); ?>addNew"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    ...
                    <!--<div class="box-tools">
                        <form action="<?php echo base_url() ?>admin/flowerListing" method="POST" id="searchList">
                ...
                <table id="flower_data" class="table table-bordered table-striped">
				<thead>
                    <tr>
                       <th>Title</th>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('ul.pagination li a').click(function (e) {
            ...
            jQuery("#searchList").attr("action", baseURL + "admin/flower/flowerListing/" + value);
...
jQuery(document).ready(function(){
	...
	jQuery(document).on("click", ".deleteFlower", function(){
		var fId = $(this).data("fid"),
			hitURL = baseURL + "admin/flower/deleteFlower/",
			currentRow = $(this);
...
<script>
  var table = $('#flower_data').dataTable( { 
		//ajax: "<?=base_url('admin/datatable_json')?>",
		ajax: {
            url: "<?=base_url('admin/flower/datatable_json')?>",
            type: "GET"
        },
		processing: true,
		serverSide: true, 

        ...
        <div class="form-group6">
         ...
         <div class="col-sm-12">
          ...
          <label>Select State</label>
           <select id="pstate" class="form-control state-dropd" required>
          ...
          <select id="pcity" class="form-control city-dropd" required>
      ...
      <div class="modal-body">
        <div class="form-group6">
         ...
         <div class="col-sm-12">
          ...
          <div class="col-sm-12">
          <label>Select State</label>
           <select id="dstate" class="form-control state-dropd">
            <option>Select State</option>      
		  </select>
          </div>
          ...
          <div class="col-sm-12">
		  <label>Select City</label>
          <select id="dcity" class="form-control city-dropd">
...
<div class="container-fluid inner">
        ...
        <div class="form-group1">
          ...
          <div class="col-sm-12">
		   ...
		   <?php
		     ...
		     echo form_open_multipart('home/addOrder',$attr);
  ...
  <?php endforeach; ?>
        ...
        <div class="col-sm-12">
            <label>From Address:( Double Click to clear selection )</label>  
			 ...
			 <?php foreach($fromadd as $fadd): ?>
			  ...
			  <div class="card bg-primary">
				...
				<div class="card-body">
				  <div class="col-sm-1"><input type="radio" name="from_radd"  value="<?= $fadd->id?>"></div> 
				  <div class="col-sm-11"><p class="card-text"><?= $fadd->from_address?></p></div>
				</div>
			  </div>
			...
			<span>
			    <div class="col-sm-1"><input type="checkbox" class="form-control" id="special_req02" name="special_req02" ></div>
			<div class="col-sm-11"><label class="form-check-label" for="exampleCheck1">Pickup address same as From Address</label></span></div>
			...
			<div class="clearfix"></div>
			 ...
			 <?php foreach($picadd as $padd): ?>
			  ...
			  <div class="card bg-primary">
				<div class="card-body ">
				    	<div class="col-sm-1"><input type="radio" name="pick_radd"  value="<?= $padd->id?>"></div>
				  <div class="col-sm-11"><p class="card-text"><?= $padd->pickup_address?></p></div>
				</div>
			  </div>
			 ...
			 <div class="pic-add">
			    ...
			    <label>Enter Pickup Pincode*</label>
			     <input type="text" name="pickup_pincode" id="pickup_pincode" class="form-control" maxlength="6" placeholder="Pincode" required maxlength="6">
...
<div class="clearfix"></div>
			 ...
			 <?php foreach($dropadd as $dadd): ?>
			  ...
			  <div class="card bg-primary">
				<div class="card-body">
				  	<div class="col-sm-1"><input type="radio" name="drop_radd"  value="<?= $dadd->id?>"></div>
				  	<div class="col-sm-11"><p class="card-text"><?= $dadd->drop_address?></p></div>
				</div>
			  </div>
			 ...
			 <label> Enter Drop Pincode*</label>
  ...
  <input type="submit" id="pay" name="pay" class="btn btn-default" value="Pay">
            ...
            function addRow()
            {
				 ...
				 }else if( qty == '' )
				{
                  ...
                  cel4.innerHTML = qty;
				    ...
				    $.ajax({
							url     : '<?php echo base_url("home/addParcel"); ?>',
							type    : "POST",
...
$("#pickup_pincode").change(function()
  ...
  //  $(".pin_error").html("<img src='http://localhost/vn24/assets/images/loading.gif' alt='Loading'/>");
    ...
    $.ajax(
    {
    url     : '<?php echo base_url("home/pin_search"); ?>',
    type    : "POST",
...
$("#drop_pincode").change(function()
  ...
  //  $(".pin_error").html("<img src='http://localhost/vn24/assets/images/loading.gif' alt='Loading'/>");
    ...
    $.ajax(
    {
    url     : '<?php echo base_url("home/pin_search2"); ?>',
    type    : "POST",
    data    : {pin:pin,otype:otype},
    success :function(data, textStatus, jqXHR) 
    {     
	...
	$('#pcountry').change(function () {
            ...
            {
                $.ajax({
                    url: "<?php echo base_url(); ?>home/fetch_states",
                    method: "POST",
                    data: dataJson,
		...
		$('#pstate').change(function () {
            ...
            {
                $.ajax({
                    url: "<?php echo base_url(); ?>home/fetch_cities",
                    method: "POST",
                    data: dataJson,
                    success: function (data)
                    {
